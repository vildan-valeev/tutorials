...
Позволяет отделить процесс конструирования сложного объекта от его представления.
Используя один и тот же код для конструирования объектов можно получать различные его представления

В каких случаях использовать?
1. Процесс(алгоритм) создания сложного объекта не должен зависеть от того из каких частей он состоит и как эти части
стыкуются между собой
2. Процесс создания объектов должен обеспечивать его различные представления
