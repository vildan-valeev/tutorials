...
1 Когда необходимо предоставить простой или урезанный интерфейс к сложной подсистеме.
2 Когда необходимо разложить подсистему на отдельные слои
"""
...
class IClient(ABC):
    """
    Базовый класс задающий интерфейс клиента
    """
