...
Command Команда
Использовать:
1. Необходимо осуществить параметризацию объектов выполняемым действием
2. Запросы должны организовываться в очереди или по расписанию
3. Важно иметь возможность поддерживать отмену операций или протоколирование изменений

Достоинства:
1. Легко организуются операции отмены. повторения и отложеный запуск операций
2. Можно собирать сложные команды из простых

Недостатки
Вводится большое количество дополнительных классов!!!
